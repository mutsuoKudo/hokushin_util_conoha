...
try {
    ...
    $sql = 'SELECT COUNT(*) from kaizoudo_tbl';
    $stmt = $dbh->query($sql);
...
<html lang="ja" ng-app="app">
    <head>
        ...
        <script src="kaizoudo_controller.js"></script>
    </head>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <!-- <form id="form1" action="kaizoudo_tbl.php" method="POST" >
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <!--チェックボックスALL-->
					　　<th>
                                <form class="custom-checkbox" action="kaizoudo_tbl.php" method="POST">
                                    <input type="checkbox" id="selectAll" name="selectAll" value="0" form="form1">
                                    <label for="selectAll"></label>
                                </form>
                            </th>
                            <th width="80px">ID</th>
                            <th width="150px">解像度</th>
                            <th width="200px">解像度詳細</th>
                            <th width="150px">操作</th>
                        </tr>
                    </thead>

                    <tbody>						
                        <tr ng-controller="DetailCtrl" ng-repeat="kaizoudo in kaizoudos| limitTo: 5: <?php echo($start); ?>">
                            <!--チェックボックス個別-->
                            <td>
                                <form class="custom-checkbox" action="kaizoudo_tbl.php" method="POST">
                                    <input type="checkbox" class="selectCheckbox" name="options[{{kaizoudo.id}}]" value="{{kaizoudo.id}}" form="form1">
                                    <label for="checkbox{{kaizoudo.id}}"></label>
                                </form>
                            </td> 

                            <td >{{kaizoudo.id}}</td>
                            <td ><input ng-model="kaizoudo.kaizoudo" size="15" required></td>
                            <td ><input ng-model="kaizoudo.kaizoudo_shousai" size="30" required></td>
                            <td>
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        ...
                        if ($page > 1) {
                            ?>
                            <li class="page-item"><a href="kaizoudo_tbl.php?page=<?php print($page - 1); ?>">前のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 前のページ -->
                        ...
                        if ($page < $maxPage) {
                            ?>　　
                            <li class="page-item"><a href="kaizoudo_tbl.php?page=<?php print($page + 1); ?>">次のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 次のページ -->
                    ...
                    <form>
                        ...
                        <div class="modal-body">										
                            <div class="form-group">
                                <label>ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_kaizoudo.newid" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>解像度&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_kaizoudo.kaizoudo" size="20" required>
                            </div>
                            <div class="form-group">
                                <label>解像度詳細</label>
                                <input ng-model="new_kaizoudo.kaizoudo_shousai" size="30" required>
                            </div>				
                        </div>
                        <div class="modal-footer">
                            <button onclick="location.href = 'kaizoudo_tbl.php'" class="btn btn-default">キャンセル</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <input type="submit" onclick="location.href = 'kaizoudo_tbl.php'" class="btn btn-default" value="キャンセル">
                            <!--                            <form id="form1" action="kaizoudo_tbl.php" method="POST">
                                                            <input type="submit" value="削除" name="selectDelete" class="btn btn-danger">
                                                        </form>-->
<!--                            <button onclick="location.href = 'kaizoudo_tbl.php?selectDelete=ok'" class="btn btn-danger">削除</button> -->
