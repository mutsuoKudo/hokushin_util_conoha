            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <!--チェックボックスALL-->
					　　<th>
                                <form class="custom-checkbox" action="model_tbl.php" method="POST">
                    ...
                    <tbody>						
                        <tr ng-controller="DetailCtrl" ng-repeat="model in models| limitTo: 5: <?php echo($start); ?>">
                            <!--チェックボックス個別-->
                            <td>
                                <form class="custom-checkbox" action="model_tbl.php" method="POST">
                                    <input type="checkbox" class="selectCheckbox" name="options[{{model.id}}]" value="{{model.id}}" form="form1">
                                    <label for="checkbox{{model.id}}"></label>
                                </form>
                            </td> 

                            <td >{{model.id}}</td>
                            <td ><input ng-model="model.name" size="15" required></td>

                            <!-- <td ><input ng-model="display_model.maker_id" size="10" required></td> -->
                            <!-- メーカーidドロップダウン -->
                            <td><select ng-model="model.maker_id">
                                <?php
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        ...
                        if ($page > 1) {
                            ?>
                            <li class="page-item"><a href="model_tbl.php?page=<?php print($page - 1); ?>">前のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 前のページ -->
                        ...
                        if ($page < $maxPage) {
                            ?>　　
                            <li class="page-item"><a href="model_tbl.php?page=<?php print($page + 1); ?>">次のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 次のページ -->
                    ...
                    <form>
                        ...
                        <div class="modal-body">										
                            <div class="form-group">
                                <label>ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_model.newid" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>モデル名&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_model.name" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>メーカーid</label> 
                                <!-- <input ng-model="new_display_model.maker_id" size="30" required> -->
                                <select ng-model="new_model.maker_id">
                                <?php
                            ...
                            <div class="form-group">
                                <label>URL&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <textarea ng-model="new_model.model_url" cols="30" rows="3" required></textarea>
                                <!-- <input ng-model="new_display_model.model_url" size="30" required> -->
                            </div>				
                        </div>
                        <div class="modal-footer">
                            <button onclick="location.href = 'model_tbl.php'" class="btn btn-default">キャンセル</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <input type="submit" onclick="location.href = 'model_tbl.php'" class="btn btn-default" value="キャンセル">
                            <!--                            <form id="form1" action="processor_tbl.php" method="POST">
