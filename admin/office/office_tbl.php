...
<html lang="ja" ng-app="app">
    <head>
        ...
        <title>Microsoft Officeの種類</title>
        ...
        <script src="office_controller.js"></script>
            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <!--チェックボックスALL-->
					　　<th>
                                <form class="custom-checkbox" action="office_tbl.php" method="POST">
                                    <input type="checkbox" id="selectAll" name="selectAll" value="0" form="form1">
                                    <label for="selectAll"></label>
                                </form>
                            </th>
                            <th width="80px">ID</th>
                            <th width="150px">バージョン</th>
                            <th width="200px">プロダクトキー</th>
                            <th width="150px">操作</th>
                        </tr>
                    </thead>

                    <tbody>						
                        <tr ng-controller="DetailCtrl" ng-repeat="office in offices| limitTo: 5: <?php echo($start); ?>">
                            <!--チェックボックス個別-->
                            <td>
                                <form class="custom-checkbox" action="office_tbl.php" method="POST">
                                    <input type="checkbox" class="selectCheckbox" name="options[{{office.id}}]" value="{{office.id}}" form="form1">
                                    <label for="checkbox{{office.id}}"></label>
                                </form>
                            </td> 

                            <td >{{office.id}}</td>
                            <td ><input ng-model="office.name" size="15" required></td>
                            <td ><input ng-model="office.product_key" size="30" required></td>
                            <td>
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        ...
                        if ($page > 1) {
                            ?>
                            <li class="page-item"><a href="office_tbl.php?page=<?php print($page - 1); ?>">前のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 前のページ -->
                        ...
                        if ($page < $maxPage) {
                            ?>　　
                            <li class="page-item"><a href="office_tbl.php?page=<?php print($page + 1); ?>">次のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 次のページ -->
                    ...
                    <form>
                        ...
                        <div class="modal-body">										
                            <div class="form-group">
                                <label>ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_office.newid" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>バージョン&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        ...
                        <div class="modal-footer">
                            <button onclick="location.href = 'office_tbl.php'" class="btn btn-default">キャンセル</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <input type="submit" onclick="location.href = 'office_tbl.php'" class="btn btn-default" value="キャンセル">
                            <!--                            <form id="form1" action="processor_tbl.php" method="POST">
