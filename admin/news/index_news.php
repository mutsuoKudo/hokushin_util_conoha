            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <!--チェックボックスALL-->
					　　<th>
                                <form class="custom-checkbox" action="index_news.php" method="POST">
                            ...
                            <th width="300px">ニュース</th>
                            <th width="150px">操作</th>
                        </tr>
                    </thead>

                    <tbody>						
                        <tr ng-controller="DetailCtrl" ng-repeat="news in newss| limitTo: 5: <?php echo($start); ?>">
                            <!--チェックボックス個別-->
                            <td>
                                <form class="custom-checkbox" action="processor_tbl.php" method="POST">
                                    <input type="checkbox" class="selectCheckbox" name="options[{{news.id}}]" value="{{news.id}}" form="form1">
                                    <label for="checkbox{{news.id}}"></label>
                                </form>
                            </td> 

                            <td >{{news.id}}</td>
                            <td ><input ng-model="news.date" size="15" required></td>
                            <td ><textarea ng-model="news.news" cols="60" row="2" required></textarea></td>
                            <td>
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        ...
                        if ($page > 1) {
                            ?>
                            <li class="page-item"><a href="index_news.php?page=<?php print($page - 1); ?>">前のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 前のページ -->
                        ...
                        if ($page < $maxPage) {
                            ?>　　
                            <li class="page-item"><a href="index_news.php?page=<?php print($page + 1); ?>">次のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 次のページ -->
                    ...
                    <form>
                        ...
                        <div class="modal-body">										
                            <div class="form-group">
                                <label>ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_news.newid" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>日付&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_news.date" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>ニュース</label>
                                <textarea ng-model="new_news.news" cols="30" row="3" required></textarea>
                            </div>				
                        </div>
                        <div class="modal-footer">
                            <button onclick="location.href = 'index_news.php'" class="btn btn-default">キャンセル</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <input type="submit" onclick="location.href = 'index_news.php'" class="btn btn-default" value="キャンセル">
