...
try {
    ...
    $sql = 'SELECT COUNT(*) from jyotai_tbl';
    $stmt = $dbh->query($sql);
...
<html lang="ja" ng-app="app">
    <head>
        ...
        <script src="jyotai_controller.js"></script>
            ...
            <div class="table-wrapper">
                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            <!--チェックボックスALL-->
					　　<th>
                                <form class="custom-checkbox" action="jyotai_tbl.php" method="POST">
                    ...
                    <tbody>						
                        <tr ng-controller="DetailCtrl" ng-repeat="jyotai in jyotais| limitTo: 5: <?php echo($start); ?>">
                            <!--チェックボックス個別-->
                            <td>
                                <form class="custom-checkbox" action="jyotai_tbl.php" method="POST">
                                    <input type="checkbox" class="selectCheckbox" name="options[{{jyotai.id}}]" value="{{jyotai.id}}" form="form1">
                                    <label for="checkbox{{jyotai.id}}"></label>
                                </form>
                            </td> 
                ...
                <div class="clearfix">
                    <ul class="pagination">
                        ...
                        if ($page > 1) {
                            ?>
                            <li class="page-item"><a href="jyotai_tbl.php?page=<?php print($page - 1); ?>">前のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 前のページ -->
                        ...
                        if ($page < $maxPage) {
                            ?>　　
                            <li class="page-item"><a href="jyotai_tbl.php?page=<?php print($page + 1); ?>">次のページへ</a></li>
                            <?php
                        } else {
                            ?>
                            <!-- 次のページ -->
                    ...
                    <form>
                        ...
                        <div class="modal-body">										
                            <div class="form-group">
                                <label>ID&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <input ng-model="new_jyotai.newid" size="15" required>
                            </div>
                            <div class="form-group">
                                <label>状態&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        ...
                        <div class="modal-footer">
                            <button onclick="location.href = 'jyotai_tbl.php'" class="btn btn-default">キャンセル</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form>
                        ...
                        <div class="modal-footer">
                            <input type="submit" onclick="location.href = 'jyotai_tbl.php'" class="btn btn-default" value="キャンセル">
                            <!--                            <form id="form1" action="processor_tbl.php" method="POST">
